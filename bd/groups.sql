...
(2, 'Выполняем план ', 'Продажники в Туле', '5', 2, '2,3'),
(3, 'выполняем план', 'Продажники в Подольске', '1,6', 2, '8,13'),
(4, 'Чтобы стать хокаге надо жёстко подымиться вторячком', 'Древние русы', '2,,4,5', 14, '1,3,5,6,7,8,9'),
(5, 'В нас вкладывают большие надежды, не подведем)', 'Большие надежды', '5,6', 14, '3,13,14');
